(() => {
  ...
  let _renderPrevView      = null;   // Rastrea la vista anterior para preservar formularios  // Ajustes requiere reautenticacion
...
/* CARNETS QR */
  ...
  function renderEvents(){
    ...
    // Botones de vista
    const btnLista='<button class="btn '+(calendarView==="list"?"primary":"")+ '" data-action="events-view-list">Lista</button>';
    const btnCal='<button class="btn '+(calendarView==="calendar"?"primary":"")+ '" data-action="events-view-calendar">Calendario</button>';
    const viewBtns='<div style="display:flex;gap:8px">'+btnLista+btnCal+'</div>';
    ...
    return renderHeader("Eventos y calendario","Gestiona competencias, travesias y actividades internas.",viewBtns)
      ...
      +     '<div class="split-actions wide"><button class="btn accent" type="submit">'+icon("calendar")+' Crear externo</button></div>'
      +   '</form>'
      ...
      +       '<div class="split-actions wide"><button class="btn primary" type="submit">'+icon("calendar")+' Agregar</button></div>'
      +     '</form>'
      +   '</div>'
      + '</div>'
      + '<div class="panel">'
