...
/* CARNETS QR */
  ...
  async function showCheckinScreen(studentParam,source="qr"){
    ...
    if(vencidoHoy) extraHtml='<div class="checkin-warning danger">El plan de este alumno ya vencio por fecha — esta clase se registra fuera del periodo del plan.</div>'+extraHtml;
    const avisarBtnHtml=(student.phone&&remainingNow<=1&&!extra)
