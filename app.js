    ...
    switch(action.dataset.action){
      ...
      case "adjust-total-classes": {
        ...
        if(stAdj){
          ...
          const input=window.prompt(`¿Cuantas clases en TOTAL debe tener ${stAdj.name} en su plan actual?\n\nEl plan "${PLAN_LABELS[stAdj.planType]||stAdj.planType}" trae ${base} clases de base. Si escribes un numero mayor, la diferencia se guarda como clases de regalo.`, String(actual));
          if(input!==null && input.trim()!==""){
            ...
            if(!isNaN(nuevoTotal) && nuevoTotal>=0){
              ...
              saveState();
              setToast(`Clases totales de ${stAdj.name} ajustadas a ${nuevoTotal}.`);
            } else {
